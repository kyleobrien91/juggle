...
api_v1_urlpatterns = [
    path(
        ...
        include(("juggle.apps.accounts.api.v1.urls", "accounts"), namespace="api-v1-accounts"),
    )
]
...
# enable Swagger
if "SWAGGER" in settings.JUGGLE_FEATURES:
    ...
    api_v1_schema_view = get_schema_view(
        openapi.Info(
            title="juggle",
            default_version="v1",
            description="juggle API v1 description",
        ),
        public=True,
